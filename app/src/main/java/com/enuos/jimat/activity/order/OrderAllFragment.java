...
public class OrderAllFragment extends BaseFragment {
    ...
    @BindView(R.id.order_all_rv)
    PullToRefreshRecyclerView pullToRefreshRecyclerView;
    @BindView(R.id.order_all_result_layout)
    RelativeLayout mOrderAllResultLayout;
    private Unbinder unbinder;

    private User mUser;
    protected RecyclerView mMineOrderRv;
    ...
    public View initView() {
        return View.inflate(mContext, R.layout.order_all, null);
    }
    ...
    public void initData() {
        ...
        mMineOrderRv = pullToRefreshRecyclerView.getRefreshableView();
        mMineOrderRv.setLayoutManager(new LinearLayoutManager(
    ...
    private void setEmptyView(Boolean isEmpty) {
        ConstraintLayout empty = getActivity().findViewById(R.id.item_order_all_empty_all);
        if (isEmpty) {
            empty.setVisibility(View.VISIBLE);
            mOrderAllResultLayout.setVisibility(View.GONE);
        } else {
            empty.setVisibility(View.GONE);
            mOrderAllResultLayout.setVisibility(View.VISIBLE);
        }
    }
    ...
    private void loadPage(final ArrayList<OrderListItem> orderList) {
        ...
        adapter.setMyClickListener(new OrderAdapter.MyClickListener() {
            // 选择
            @Override
        ...
        mMineOrderRv.setAdapter(adapter);
    }
