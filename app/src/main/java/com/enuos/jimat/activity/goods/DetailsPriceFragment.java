...
import com.enuos.jimat.adapter.PriceNewAdapter;
...
public class DetailsPriceFragment extends BaseFragment {
    ...
    public View initView() {
        return View.inflate(mContext, R.layout.fragment_details_price, null);
    }
     ...
     * 加载界面
     */
    private void loadPage(final ArrayList<PriceListItem> priceList) {
        adapter = new PriceNewAdapter(mContext, priceList);
        adapter.setMyClickListener(new PriceNewAdapter.MyClickListener() {
            // 选择
            @Override
        ...
        protected void onPostExecute(Object[] result) {
            if ((boolean) result[0]) {
                try {
                    ...
                    Log.e("TAG", "价格maxCount：" + String.valueOf(maxCount));
                    Gson gson = new Gson();
