...
import com.enuos.jimat.activity.home.adapter.HomePageAdapter;
...
public class HomeNewActivity1 extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRcyclerView.setLayoutManager(new LinearLayoutManager(this));
        List<HomeItem> data = new ArrayList<>();
        HomePageAdapter adapter1 = new HomePageAdapter(R.layout.item_address, data);
        myRcyclerView.setAdapter(adapter1);
        adapter1.addHeaderView(viewHader);
        autoBanner();
        initData();
    }
