...
import com.enuos.jimat.adapter.HistoryBuyAdapter;
...
public class HistoryBuyActivity extends BaseActivity {
    ...
    @BindView(R.id.history_buy_back)
    ImageView mBack;
    @BindView(R.id.history_buy_rv)
    RecyclerView mHistoryBuyRv;
     ...
     * 点击事件
     */
    @OnClick({R.id.history_buy_back})
    public void onViewClick(View view) {
        switch (view.getId()) {
            // 返回
            case R.id.history_buy_back:
                finish();
                break;
        }
    }
    ...
    private void setEmptyView(Boolean isEmpty) {
        ConstraintLayout empty = mBaseActivity.findViewById(R.id.item_history_buy_empty_all);
        if (isEmpty) {
    ...
    private void loadPage(JSONObject jsonObject) {
        try {
            ...
            HistoryBuyAdapter adapter = new HistoryBuyAdapter(mBaseActivity, mJSONArray);
            mHistoryBuyRv.setAdapter(adapter);
            mHistoryBuyRv.setLayoutManager(new LinearLayoutManager(
