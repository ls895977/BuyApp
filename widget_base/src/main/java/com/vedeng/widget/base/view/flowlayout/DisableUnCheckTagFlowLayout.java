package com.vedeng.widget.base.view.flowlayout;
...
public class DisableUnCheckTagFlowLayout extends FlowLayout
    ...
    private SingleModeTagChangeListener mOnTagChangeListener;
    ...
    public interface SingleModeTagChangeListener {
        void onTagChange(int prePosition, int newPosition);
    }

    public DisableUnCheckTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public DisableUnCheckTagFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DisableUnCheckTagFlowLayout(Context context) {
        this(context, null);
    }
    ...
    public void setOnTagChangeListener(SingleModeTagChangeListener onTagChangeListener) {
    ...
    private void changeAdapter() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTagAdapter.setSelected(i, adapter.getItem(i))) {
                //单选并且设置了默认值，则加入默认值到已选中列表
                if (mSelectedMax == 1 && mSelectedView.size() < mSelectedMax) {
                    mSelectedView.add(i);
                }
                setChildChecked(i, tagViewContainer);
            }
            if (adapter.isEnable(i, adapter.getItem(i))) {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onTagClick(finalTagViewContainer, position,
                                    DisableUnCheckTagFlowLayout.this);
                        }
                    }
                });
            } else {
        ...
        if (!child.isChecked()) {
            ...
            if (mSelectedMax == 1 && mSelectedView.size() == 1) {
                ...
                if (mOnTagChangeListener != null) {
                    mOnTagChangeListener.onTagChange(preIndex, position);
                }
